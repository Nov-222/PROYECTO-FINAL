...
const LoginForm = React.lazy(() => import('./features/auth/LoginForm').then(module => ({ default: module.LoginForm })));
const ForgotPasswordForm = React.lazy(() => import('./features/auth/ForgotPasswordForm').then(module => ({ default: module.ForgotPasswordForm })));
const ResetPasswordForm = React.lazy(() => import('./features/auth/ResetPasswordForm').then(module => ({ default: module.ResetPasswordForm })));

const HomePage = React.lazy(() => import('./pages/HomePage').then(module => ({ default: module.HomePage })));
const MovieDetailPage = React.lazy(() => import('./pages/MovieDetailPage').then(module => ({ default: module.MovieDetailPage })));
const ScreeningSelectionPage = React.lazy(() => import('./pages/ScreeningSelectionPage').then(module => ({ default: module.ScreeningSelectionPage })));
